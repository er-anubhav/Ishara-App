...
class UsageExamples extends StatelessWidget {
  const UsageExamples({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final examples = <Widget>[
      ...
      // Note: add a dedicated setState-focused sample here.
    ];
...
class I18nExamples extends StatelessWidget {
  const I18nExamples({Key? key}) : super(key: key);
...
class StylesExamples extends StatelessWidget {
  const StylesExamples({Key? key}) : super(key: key);
...
class FormsExamples extends StatelessWidget {
  const FormsExamples({Key? key}) : super(key: key);
...
class AnimatedExamples extends StatelessWidget {
  const AnimatedExamples({Key? key}) : super(key: key);
...
class SimpleExampleWeekendsStatic extends StatefulWidget {
  const SimpleExampleWeekendsStatic({Key? key}) : super(key: key);

  @override
  State<SimpleExampleWeekendsStatic> createState() =>
...
class DisabledExample extends StatefulWidget {
  const DisabledExample({Key? key}) : super(key: key);

  @override
  State<DisabledExample> createState() => _DisabledExampleState();
}
...
class SelectedDaysUpdateExample extends StatefulWidget {
  const SelectedDaysUpdateExample({Key? key}) : super(key: key);

  @override
  State<SelectedDaysUpdateExample> createState() =>
...
class DisplayedDaysExample extends StatefulWidget {
  const DisplayedDaysExample({Key? key}) : super(key: key);

  @override
  State<DisplayedDaysExample> createState() => _DisplayedDaysExampleState();
}
...
class ElevationExample extends StatefulWidget {
  const ElevationExample({Key? key}) : super(key: key);

  @override
  State<ElevationExample> createState() => _ElevationExampleState();
}
...
class CurrentLocaleExample extends StatefulWidget {
  const CurrentLocaleExample({Key? key}) : super(key: key);

  @override
  State<CurrentLocaleExample> createState() => _CurrentLocaleExampleState();
}
...
class _CurrentLocaleExampleState extends State<CurrentLocaleExample> {
  ...
  @override
  Widget build(BuildContext context) {
    // Note: This example can be simplified further.
    // Note: A future version could look like this:
    // initializeDateFormatting...
    // final dateSymbols = DateFormat().dateSymbols;
    final locale = Localizations.localeOf(context);
    final DateSymbols dateSymbols = dateSymbolsForLocale(locale);
...
TextDirection getTextDirection(Locale locale) {
  ...
  // Note: this can be replaced by a framework-backed RTL/LTR lookup later.
...
DateSymbols dateSymbolsForLocale(Locale locale) {
  final symbols = dateTimeSymbolMap();
  return symbols[locale.toString()] ??
      symbols[locale.languageCode] ??
      symbols['en_US'] ??
      symbols.values.first;
}

class FirstDayOfWeekDateTime extends StatelessWidget {
  const FirstDayOfWeekDateTime({Key? key}) : super(key: key);
...
class CustomWeekdaysTexts extends StatelessWidget {
  const CustomWeekdaysTexts({Key? key}) : super(key: key);
...
class ShortAndNarrowGermanExample extends StatelessWidget {
  const ShortAndNarrowGermanExample({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final DateSymbols de = dateSymbolsForLocale(const Locale('de'));
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: <Widget>[
...
class RegionMattersSpanishExample extends StatelessWidget {
  const RegionMattersSpanishExample({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final DateSymbols mx = dateSymbolsForLocale(const Locale('es', 'MX'));
    final DateSymbols es = dateSymbolsForLocale(const Locale('es', 'ES'));
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: <Widget>[
...
class SaneDefaultThemeExample extends StatefulWidget {
  const SaneDefaultThemeExample({Key? key}) : super(key: key);

  @override
  State<SaneDefaultThemeExample> createState() =>
...
class SimpleShapesExample extends StatefulWidget {
  const SimpleShapesExample({Key? key}) : super(key: key);

  @override
  State<SimpleShapesExample> createState() => _SimpleShapesExampleState();
}
...
class CustomShapesExample extends StatefulWidget {
  const CustomShapesExample({Key? key}) : super(key: key);

  @override
  State<CustomShapesExample> createState() => _CustomShapesExampleState();
}
...
class InheritedThemeExample extends StatelessWidget {
  const InheritedThemeExample({Key? key}) : super(key: key);
...
class FirstDayOfWeekExample extends StatelessWidget {
  const FirstDayOfWeekExample({Key? key}) : super(key: key);
