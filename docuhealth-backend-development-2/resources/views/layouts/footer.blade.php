<!-- BEGIN: Footer-->
    ...
    <footer class="footer footer-static footer-light">
      <p class="clearfix mb-0"><span class="float-left d-inline-block"></span><span class="float-right d-sm-inline-block d-none">@<?php echo date('Y'); ?> All Rights Reserved by<a class="text-uppercase" href="#">Docuhelath.</a></span>
