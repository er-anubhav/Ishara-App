...
<head>
  ...
  <meta name="author" content="PIXINVENT">
    <title>Notifications - Docuhealth</title>
              ...
              <form method="POST" id="send_notification_form">
                ...
                <ul class="list-unstyled mb-0" id="notification-for">
                  ...
                  <li class="d-inline-block mr-2 mb-1">
                    <fieldset>
                      <div class="checkbox">
                          <input type="checkbox" class="checkbox-input" id="sub_admin" name="notify_to[]" value="sub_admin" checked>
...
$(function(){
  ...
  { 
      TransactionTable.DataTable({
          ...
          ajax:{
                url:"{{url('/')}}/{{$auth_path}}/notifications/data",
  ...
  $(document).on('click', '.send-btn', function() {
      ...
      $.ajax({
          ...
          url: "{{url('/')}}/{{$auth_path }}/notifications",
