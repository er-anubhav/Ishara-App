...
<style>
  #TagTable_length, #TagTable_filter{
              ...
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="TagTable" class="table " style="width: 100%;">
                      <thead>
                        <tr>
                          <!-- <th>Id</th> -->
                          <th>Name</th>
...
<div class="buy-now" style="right: 60px;"><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#add_tags_modal">+</button></div>
</div>
...
@include('modal.addTags')
@include('modal.updateTags') 
<script>
