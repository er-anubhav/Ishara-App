...
<head>
    ...
    <title>Posts - Docuhelath</title>
@include('layouts.header')
<style>
  #PostTable_length, #PostTable_filter{
              ...
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <a href="{{url('/')}}{{$auth_path}}/doctors/create" class="btn btn-secondary" style="float: right;">+ Add Doctor</a>
...
$(document).ready( function () {
      ...
      PostTable.DataTable({
          ...
          processing: true,
          ordering: false,
          ajax: "{{url('/')}}{{$auth_path}}/doctors/data",
          "aoColumns": [
              {
                  mData: 'name'
              },
    ...
    const status_change = (id = 0, action = 'enable') => {
      $.ajax({
              type: "post",
              url: "{{url('/')}}{{$auth_path}}/doctors/status",
