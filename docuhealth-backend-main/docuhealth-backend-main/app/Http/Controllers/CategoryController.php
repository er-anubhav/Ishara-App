...
class CategoryController extends Controller
{
    ...
    public function data(Request $request){
        ...
        return datatables()->of($data)->addColumn('action', function ($data) {
            ...
            if($data->is_active == 'Yes'){
                ...
                $button .= '<div class="btn-group"><a href="javascript:void()" name="enable" data-value="'.$data->id.'" class="btn btn-sm btn-success status-btn"><i class="bx bx-check"></i></a>';
            }
            ...
            'data-value' => '{{$id}}|{{$name}}|{{$position}}|{{$icon}}',
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('icon') != "") {
            ...
            if (!$this->image_validation($request->file('icon'))) {
