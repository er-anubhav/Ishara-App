                ...
                if ($user->is_active == 'Yes') {
                    ...
                    if ($user->save()) {
                        ...
                        if (empty($profile)) {
                            ...
                            $profile_data = ['name' => $request->name, 'icon' => $profile_icon, 'user_id' => $user->id];
                            if ($request->device_token) 
                                $profile_data['device_token'] = $request->device_token;

                            $profiles = UserProfile::create($profile_data);
                            $profiles->name = $request->name;
                            $profiles->icon = DisplayPath::user_profile_icon($profile_icon);
